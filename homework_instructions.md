...
#### Config Setup - Can use either homemade ORM using instructions below, OR can use Sequelize.
...
## If you are not using a custom ORM, use one of the Sequelize activities as a guide to set up both your config and models folders with Sequelize, or use the Sequelize CLI to do so.  

     * NOTE: If you wish to use Sequelize instead of a homemade ORM but aren't sure where to start, reach out to a TA! 
